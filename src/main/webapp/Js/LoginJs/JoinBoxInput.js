 ...
 */
    if (p!=p_cf) { 
        ...
        document.getElementById('pw_check_msg').innerHTML = "비밀번호가 같습니다."; 
   		document.getElementById('pw_check_msg').style.color="green";
    } 
    if (p_cf=="") { 
 ...
 function Exid(){
	window.open("../WindowLoginPage/LoginExId.jsp","exid","width=600, height=500,top=500,left=500");
}
