...
<body>
	<div id="MainSearch">
        ...
        <div><p>서울 도서관</p></div>
        <hr>
        <div><img src="../../Img/LoginImg/findIdBg.gif"><p>비밀번호 찾기</p></div>
        
        <ul class="radioBox">
            <li><p>비밀번호를 찾으실 방법을 선택해 주세요</p></li>
        </ul>
        ...
        <div id="box_form">
            <form action="LoginSearchPwPhone.do" method="post">
                <ul>
                    <li>전화번호</li>
                    <li>
        ...
        <div id="email_box">
            <form action="LoginSearchPwEmail.do" method="post">
